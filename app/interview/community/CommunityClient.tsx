                    ...
                    <article className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm rounded-2xl border border-slate-200/50 dark:border-slate-800/50 hover:border-blue-400/50 dark:hover:border-blue-600/50 transition-all duration-300 hover:shadow-xl hover:shadow-blue-500/10 dark:hover:shadow-blue-400/10 overflow-hidden">
                      <div className="p-6">
                        ...
                        {interview.review_summary && (
                          <div className="bg-slate-50/80 dark:bg-slate-800/50 rounded-xl p-4 my-5">
                            <div className="flex items-center gap-2 mb-3">
                              <div className="w-6 h-6 bg-gray-100 dark:bg-gray-900/50 rounded-lg flex items-center justify-center flex-shrink-0">
                                <span className="text-gray-600 dark:text-gray-400 text-xs font-bold">📝</span>
                              </div>
                              <span className="text-sm font-medium text-slate-700 dark:text-slate-300">면접 후기 요약</span>
                            </div>
                        ...
                        {interview.first_question && (
                          <div className="bg-slate-50/80 dark:bg-slate-800/50 rounded-xl p-4 my-5">
                            <div className="flex items-center gap-2 mb-3">
                              <div className="w-6 h-6 bg-blue-100 dark:bg-blue-900/50 rounded-lg flex items-center justify-center flex-shrink-0">
                      ...
                      <div className="px-6 py-4 bg-slate-50/50 dark:bg-slate-800/30 border-t border-slate-200/50 dark:border-slate-700/50">
                        <div className="flex items-center justify-between text-sm">
                          ...
                          <div className="flex items-center gap-1.5 text-slate-400 dark:text-slate-500 group-hover:text-blue-500 dark:group-hover:text-blue-400 transition-colors">

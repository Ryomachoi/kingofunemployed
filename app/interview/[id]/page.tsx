          ...
          <div className="flex items-start justify-between mb-6">
            <div className="flex-1">
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <span className={`px-4 py-2 rounded-xl text-sm font-semibold flex items-center gap-2 ${
                  interview.interview_type === 'video' ? 'bg-blue-100 text-blue-700 dark:bg-blue-900/50 dark:text-blue-300' :
                  interview.interview_type === 'in_person' ? 'bg-green-100 text-green-700 dark:bg-green-900/50 dark:text-green-300' :
                  interview.interview_type === 'phone' ? 'bg-purple-100 text-purple-700 dark:bg-purple-900/50 dark:text-purple-300' :

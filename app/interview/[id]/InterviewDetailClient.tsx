...
export default function InterviewDetailClient({ interview, userProfile, currentUserId, parsedQAList }: InterviewDetailClientProps) {
  ...
  return (
    <div className="min-h-screen">
      {/* Main Content - 통합된 단일 컨테이너 */}
      <div className="max-w-4xl mx-auto px-4 py-8">
        <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-xl border border-slate-200 dark:border-slate-700 overflow-hidden">
          
          {/* Header Section - 이제 메인 콘텐츠 내부에 포함 */}
              ...
              <div className="flex-1">
                ...
                <div className="flex flex-wrap gap-3">
                  ...
                  <span className={`px-4 py-2 rounded-xl text-sm font-semibold flex items-center gap-2 ${
                    ...
                    interview.interview_type === '대면면접' || interview.interview_type === 'in_person' ? 'bg-blue-100 text-blue-700 dark:bg-blue-900/50 dark:text-blue-300' :
                    interview.interview_type === '전화면접' || interview.interview_type === 'phone' ? 'bg-blue-100 text-blue-700 dark:bg-blue-900/50 dark:text-blue-300' :
                    interview.interview_type === 'technical' ? 'bg-blue-100 text-blue-700 dark:bg-blue-900/50 dark:text-blue-300' :
                    interview.interview_type === 'behavioral' ? 'bg-blue-100 text-blue-700 dark:bg-blue-900/50 dark:text-blue-300' :
                    'bg-slate-100 text-slate-700 dark:bg-slate-800 dark:text-slate-300'
                  }`}>
                    {interview.interview_type === '화상면접' || interview.interview_type === 'video' ? (
                      <>
                        <div className="inline-flex items-center justify-center w-4 h-4 bg-blue-600 dark:bg-blue-400 rounded-full">
                          <svg className="w-2.5 h-2.5 text-white dark:text-blue-900" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <>
                        <div className="inline-flex items-center justify-center w-4 h-4 bg-sky-600 dark:bg-sky-400 rounded-full">
                          <svg className="w-2.5 h-2.5 text-white dark:text-sky-900" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <>
                        <div className="inline-flex items-center justify-center w-4 h-4 bg-blue-700 dark:bg-blue-300 rounded-full">
                          <svg className="w-2.5 h-2.5 text-white dark:text-blue-900" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <>
                        <div className="inline-flex items-center justify-center w-4 h-4 bg-slate-600 dark:bg-slate-400 rounded-full">
                          <svg className="w-2.5 h-2.5 text-white dark:text-slate-900" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {/* Feedback & Tips Section - 커뮤니티에서는 숨김, 작성자이거나 마이페이지에서만 표시 */}
          ...
          {/* AI Feedback Section - 커뮤니티에서는 숨김, 작성자이거나 마이페이지에서만 표시 */}
              ...
              {(() => {
                ...
                if (structuredData && structuredData.total_score !== undefined && structuredData.areas) {
                  return (
                    <div className="space-y-6">
                      {/* 총점 표시 */}
                      <div className="bg-gradient-to-r from-blue-50 to-sky-50 dark:from-blue-900/20 dark:to-sky-900/20 rounded-xl p-6 border border-blue-200/50 dark:border-blue-800/50">
                      ...
                      <div className="grid gap-4">
                        {Object.entries(structuredData.areas).map(([areaName, areaData]: [string, any]) => (
                          <div key={areaName} className="bg-slate-50 dark:bg-slate-700/50 rounded-xl p-6 border border-slate-200 dark:border-slate-600">
                            <div className="flex items-center justify-between mb-4">
        ...
        <div className="text-center mt-8">
          <Link 
            href="/interview/community"
            className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-blue-500 to-sky-400 hover:from-blue-600 hover:to-sky-500 text-white font-semibold rounded-2xl shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300"
          >

...
export default async function RootLayout({
  ...
  return (
    <html lang="ko">
      <body
        className={`${geistSans.variable} ${geistMono.variable} antialiased min-h-screen bg-gradient-to-b from-blue-100 to-white dark:from-slate-900 dark:to-slate-950`}
      >

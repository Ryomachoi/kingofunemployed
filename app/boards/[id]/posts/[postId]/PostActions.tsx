...
export default function PostActions({ 
  ...
  // showOnlyLike가 true면 좋아요 버튼만 표시
  if (showOnlyLike) {
    return (
      <button
        onClick={handleLike}
        disabled={isLikeLoading}
        className={`flex items-center space-x-2 px-6 py-3 rounded-lg text-base font-medium transition-colors ${
          currentIsLiked
  ...
  // showOnlyDelete가 true면 삭제 버튼만 표시
  if (showOnlyDelete && isAuthor) {
    return (
      <>
        <button

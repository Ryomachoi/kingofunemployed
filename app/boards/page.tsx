                  ...
                  <div>
                    ...
                    {board.tags && board.tags.length > 0 && (
                      <div className="flex flex-wrap gap-1 mt-1">
                        {board.tags.slice(0, 2).map((tag, tagIndex) => (
                          <span
                            key={tagIndex}
                            className="inline-block px-1 py-0.5 text-xs bg-slate-100 dark:bg-slate-700 text-slate-600 dark:text-slate-300 rounded"
                          >
                            #{tag}
                          </span>
                        ))}
